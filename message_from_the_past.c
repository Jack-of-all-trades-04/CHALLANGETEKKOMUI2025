...
int main() {
    ...
    // Tambahan pesan dari kamu
    printf("From: Christover Angelo\n");
    printf("Terima kasih aslab atas bimbingannya selama praktikum!\n");
    printf("Semoga ilmu ini berguna ke depannya 🚀\n");
}